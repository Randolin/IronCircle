...
pages: "85–92"
aliases: ["Running an Adventure (GM Guidance and Core GM Mechanics)"]
---
# Running an Adventure (GM Guidance and Core GM Mechanics)

> [!note] Source
> Daggerheart System Reference Document 2.0, PDF pages 85–92. Public Game Content under the Darrington Press Community Gaming License; see [[Daggerheart SRD]] for the notice and how to cite. Text is machine-extracted; tables lost their columns. When it matters, the PDF wins.
...
or aid.
2-4 Fear
Major Alarge battle with a Solo
...
and betrayal).
4-8 Fear
Climactic Amajor confrontation with
...
AGILITYroll sprint leap Maneuver
...
STRENGTHroll lift smash grapple
...
FINESSEroll control hide tinker
...
deadly trap.
INSTINCTroll perceive sense na vigate
...
PRESENCEroll charm perform deceive
...
offending the queen.
Trick a god.
KNOWLEDGEroll recall anal yze comprehend
...
T o viscerally convey how a PC's actions or circumstances
affect their ability to act, grant them advantage (or impose
disadvantage) instead of adjusting the Difficulty of an action
roll.
...
preceding a future effect. Acountdown begins at a starting
...
Trigger: Abattle begins and this NPC is involved.
...
this house."
"Ithink it's really up to chance whether reinforcements will
...
- Afall from Very Close range deals 1d10+3 physical
damage.
- Afall from Close range deals 1d20+5 physical damage.
- Afall from Far or Very Far range deals 1d100+15 physical
...
resolve the conflict. Aroll might not be necessary to reach
...
makes a reaction roll. T o succeed, the instigator must beat a
