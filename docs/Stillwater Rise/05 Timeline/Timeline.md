...
exposure: secret
completeness: draft
aliases: ["Timeline", "The Clock"]
---
# Timeline

Days are relative to **Day 1**, the morning the body came up. **Day 1 is the 1st of the month**; Vera went in the water the night of the 31st/1st (Day 0). This note is authoritative where a character's clock disagrees with it. Reconciled 2026-09-05 with [[The Rat Line (draft-2)]].
...
| −3 months | Vera connects the folded-clothes suicides to the clearance map. [[Mickey Shale|Shale]] starts meeting her. [[Gerry Fitch|Fitch]] begins passing docket schedules upstream. Toby graduates to mimeograph crank |
| −8 months | [[Roy Pruitt]]'s stipend reports begin covering Vera |
...
| −3 days | Vera empties the card drawer and hides the file off-site |
| −2 days | Cuts the exposé stencil; leaves it unfinished |
| −1 day | Mails the letter |

## Day 0 (the night of)

| Time | What |
|---|---|
| ~9 a.m. | Skips her whole routine |
| ~1 p.m. | Corner store. Buys nothing. Hums at the counter |
| ~4 p.m. | Klein's. Doesn't touch the stencil. Writes one line on the roll |
| ~7 p.m. | Home. Lights on late. One rye, alone |
...
| ~2:40 | Car 6 assigned |
| ~2:47 | The disregard. Car 6 pulled mid-route |
| 5:50 | [[Earl Dubcek|Dubcek]] finds her upstream, in the eddy |
...
| ~14 | **The Condemnation Hearing.** Toby's block confirmed. Maas presiding under the model, Fitch at his elbow, Weaver's press in the row. Blum's week on the retainer runs out | [[Sterling Maas]], [[Esther Blum]] |
| ~18–20 | **Toby's demolition eve.** The walk, ~2 a.m., unless prevented. Movable: the hearing or Fitch can pull it earlier | [[Toby Small]], [[Manny Bunting]] |
| week 2+ | Bunting visits Klein's, looking. Then the make-good: the archive. The Golem wakes | [[August Klein]] |
| ~37 | **The Ribbon-Cutting.** The Span opens. Maas's triumph, Weaver's front page, Rimm's horn, Day's microphone, and the district's practical end if unresolved | everyone |

Saving a name moves its date. It does not erase it. Watch the demolition schedule the way sailors watch weather.
