...
board: route
role: the Daughter
opens: "Maas — routing, drawer numbers, and how the signatures actually happen"
status: alive
exposure: secret
...
**Image prompt — full body & wardrobe:** Full-figure view of a tall, broad-shouldered white woman in her early thirties standing straight with a worn cardboard document folder held against her side. She wears a plain, well-made dark wool coat over a simple blouse and skirt, flat practical shoes, and no jewelry anywhere.
